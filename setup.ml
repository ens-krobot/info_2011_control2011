...
(* OASIS_START *)
(* DO NOT EDIT (digest: 68f0d28458629900e455b9cdb4d1eb1b) *)
(*
...
# 21 "/media/data/ocaml/oasis/src/oasis/OASISContext.ml"
...
# 21 "/media/data/ocaml/oasis/src/oasis/OASISUtils.ml"
...
# 21 "/media/data/ocaml/oasis/src/oasis/PropList.ml"
...
# 71 "/media/data/ocaml/oasis/src/oasis/PropList.ml"
  end
...
# 21 "/media/data/ocaml/oasis/src/oasis/OASISMessage.ml"
...
# 21 "/media/data/ocaml/oasis/src/oasis/OASISVersion.ml"
...
# 21 "/media/data/ocaml/oasis/src/oasis/OASISLicense.ml"
...
# 21 "/media/data/ocaml/oasis/src/oasis/OASISTypes.ml"
...
# 102 "/media/data/ocaml/oasis/src/oasis/OASISTypes.ml"
...
# 21 "/media/data/ocaml/oasis/src/oasis/OASISUnixPath.ml"
...
# 21 "/media/data/ocaml/oasis/src/oasis/OASISSection.ml"
...
# 21 "/media/data/ocaml/oasis/src/oasis/OASISBuildSection.ml"
  
end

module OASISExecutable = struct
# 21 "/media/data/ocaml/oasis/src/oasis/OASISExecutable.ml"
...
# 21 "/media/data/ocaml/oasis/src/oasis/OASISLibrary.ml"
...
# 21 "/media/data/ocaml/oasis/src/oasis/OASISFlag.ml"
  
end

module OASISPackage = struct
# 21 "/media/data/ocaml/oasis/src/oasis/OASISPackage.ml"
  
end

module OASISSourceRepository = struct
# 21 "/media/data/ocaml/oasis/src/oasis/OASISSourceRepository.ml"
  
end

module OASISTest = struct
# 21 "/media/data/ocaml/oasis/src/oasis/OASISTest.ml"
  
end

module OASISDocument = struct
# 21 "/media/data/ocaml/oasis/src/oasis/OASISDocument.ml"
...
# 21 "/media/data/ocaml/oasis/src/base/BaseContext.ml"
...
# 21 "/media/data/ocaml/oasis/src/base/BaseMessage.ml"
...
# 21 "/media/data/ocaml/oasis/src/base/BaseFilePath.ml"
...
# 21 "/media/data/ocaml/oasis/src/base/BaseEnv.ml"
...
# 21 "/media/data/ocaml/oasis/src/base/BaseExec.ml"
...
# 21 "/media/data/ocaml/oasis/src/base/BaseArgExt.ml"
...
# 21 "/media/data/ocaml/oasis/src/base/BaseCheck.ml"
...
# 21 "/media/data/ocaml/oasis/src/base/BaseOCamlcConfig.ml"
...
# 21 "/media/data/ocaml/oasis/src/base/BaseStandardVar.ml"
...
# 21 "/media/data/ocaml/oasis/src/base/BaseFileAB.ml"
...
# 21 "/media/data/ocaml/oasis/src/base/BaseLog.ml"
...
# 21 "/media/data/ocaml/oasis/src/base/BaseBuilt.ml"
...
# 21 "/media/data/ocaml/oasis/src/base/BaseCustom.ml"
...
# 21 "/media/data/ocaml/oasis/src/base/BaseDynVar.ml"
...
# 21 "/media/data/ocaml/oasis/src/base/BaseTest.ml"
...
# 21 "/media/data/ocaml/oasis/src/base/BaseDoc.ml"
...
# 21 "/media/data/ocaml/oasis/src/base/BaseSetup.ml"
...
# 21 "/media/data/ocaml/oasis/src/plugins/internal/InternalConfigurePlugin.ml"
...
# 21 "/media/data/ocaml/oasis/src/plugins/internal/InternalInstallPlugin.ml"
...
# 21 "/media/data/ocaml/oasis/src/plugins/ocamlbuild/OCamlbuildCommon.ml"
...
# 21 "/media/data/ocaml/oasis/src/plugins/ocamlbuild/OCamlbuildPlugin.ml"
...
# 21 "/media/data/ocaml/oasis/src/plugins/ocamlbuild/OCamlbuildDocPlugin.ml"
...
let setup_t =
  {
     ...
     test = [];
     doc = [("krobot-api", OCamlbuildDocPlugin.doc_build "./")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("krobot-api", OCamlbuildDocPlugin.doc_clean "./")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          homepage =
            Some
              "http://sourceforge.net/apps/mediawiki/krobot/index.php?title=Main_Page";
          synopsis = "[Kro]bot";
          description = Some "Control program for the Eurobot robotic cup.";
          categories = [];
            ...
            [
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["krobot_message_stubs.c"];
                      bs_data_files = [];
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://krobot.git.sourceforge.net/gitroot/krobot/krobot";
                      src_repo_browser =
                        Some
                          "http://krobot.git.sourceforge.net/git/gitweb.cgi?p=krobot/krobot;a=summary";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "dump_can.ml"; });
               Flag
                 ({
                     cs_name = "gtk";
                     cs_data = PropList.Data.create ();
                   ...
                   {
                      flag_description = Some "Enable GTK programs";
                      flag_default = [(OASISExpr.EBool true, true)];
                      });
               Executable
                 ({
                     cs_name = "krobot-can-display";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "krobot_can_display.ml";
                      });
               Executable
                 ({
                     cs_name = "krobot-calibrate-sharps";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "krobot_calibrate_sharps.ml";
                      });
               Executable
                 ({
                     cs_name = "krobot-planner";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "krobot_planner.ml"; 
                   });
               Executable
                 ({
                     cs_name = "krobot-record";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "krobot_record.ml"; });
               Executable
                 ({
                     cs_name = "krobot-homologation";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "krobot_homologation.ml";
                      });
               Executable
                 ({
                     cs_name = "krobot-simulator";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "krobot_simulator.ml";
                      });
               Executable
                 ({
                     cs_name = "krobot-ax12-control";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "krobot_ax12_control.ml";
                      });
               Executable
                 ({
                     cs_name = "krobot-viewer";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "krobot_viewer.ml"; });
               Doc
                 ({
                     cs_name = "krobot-api";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for [Kro]bot";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "krobot_monitor.ml"; 
                   });
               Executable
                 ({
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "krobot_ax12_clean.ml";
                      });
               Executable
                 ({
                     cs_name = "krobot-hub";
                   ...
                   {exec_custom = false; exec_main_is = "krobot_hub.ml"; });
               Executable
                 ({
                     cs_name = "krobot-see-coin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "krobot_see_coin.ml"; 
                   });
               Executable
                 ({
                     cs_name = "krobot-sharps";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "krobot_sharps.ml"; });
               Executable
                 ({
                     cs_name = "send-can";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "send_can.ml"; });
               Executable
                 ({
                     cs_name = "krobot-vm";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "krobot_vm.ml"; });
               Executable
                 ({
                     cs_name = "krobot-webcam";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "krobot_webcam.ml"; });
               Executable
                 ({
                     cs_name = "krobot-objects";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "krobot_objects.ml"; 
                   });
               Executable
                 ({
                     cs_name = "krobot-ia";
                   ...
                   {exec_custom = false; exec_main_is = "krobot_ia.ml"; });
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "krobot_replay.ml"; });
               Executable
                 ({
                     cs_name = "krobot-kill";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "krobot_kill.ml"; });
               Executable
                 ({
                     cs_name = "krobot-plot-battery";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "krobot_plot_battery.ml";
                      });
               Executable
                 ({
                     cs_name = "krobot-plot";
                   ...
                   {exec_custom = false; exec_main_is = "krobot_plot.ml"; });
               Executable
                 ({
                     cs_name = "krobot-dump-ax12";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "krobot_dump_ax12.ml";
                      });
               Executable
                 ({
                     cs_name = "krobot-dump";
                   ...
                   {exec_custom = false; exec_main_is = "krobot_dump.ml"; });
               Executable
                 ({
                     cs_name = "krobot-dump-encoders";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "krobot_dump_encoders.ml";
                      });
               Executable
                 ({
                     cs_name = "krobot-driver";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "krobot_driver.ml"; })
            ];
          plugins =
     ...
     oasis_digest =
       Some "\143\b\170\195\207\246\234\191\179\020\128\135?a\149\155";
     oasis_exec = None;
     oasis_setup_args = [];
     };;
