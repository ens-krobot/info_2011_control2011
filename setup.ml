...
(* OASIS_START *)
(* DO NOT EDIT (digest: 26bc0c541abe4de95bc4eb3b83335f5c) *)
(*
            ...
            [
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("krobot.interfaces", None)
                        ];
                   ...
                   {
                      lib_modules =
                        ["Krobot_can"; "Krobot_bus"; "Krobot_message"];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "krobot-can-bus";
                           FindlibPackage ("lwt.syntax", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
