...
(* OASIS_START *)
(* DO NOT EDIT (digest: b04695e11f7527ee760b637f6ae5beb4) *)
(*
     ...
     package =
       {
          ...
          files_ab =
            [
               "src/driver/bus.conf.ab";
               "src/services/fr.krobot.Service.Planner.service.ab"
            ];
          sections =
            [
               Library
               ...
               Executable
                 ({
                     cs_name = "krobot-service-planner";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      ...
                      bs_data_files =
                        [
                           ("fr.krobot.Service.Planner.service",
                             Some "$datadir/$pkg_name/services")
                        ];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "krobot_service_planner.ml";
                      });
               Executable
                 ({
